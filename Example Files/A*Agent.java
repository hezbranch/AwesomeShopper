    ...
    */
    ...
    public static void main(String[] args) {
        ...
        int[][] maze = {
            ...
            {  1000,  0,100,  0,  0,100,  0,  0},
            {  0,  0,100,100,100,100,  100,  0},
            {  0,  0,  0,  0,  0,  0,  0,  0},
        };
        AStar<string> as = new AStar(maze, 0, 0, true);
	...
	//put all of your print statements in here
	...
	System.out.println("Shopping list: " + Arrays.toString(obs.players[0].shopping_list));
	System.out.println("player movement: " + obs.players[0].position[0] +" "+ obs.players[0].position[1]);


	//put your movement code in here
	//call reference to functions previously instantiated above
